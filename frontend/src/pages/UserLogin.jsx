...
export default function UserLogin() {
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center px-4 relative z-10">
      ...
      <div className="w-full max-w-md bg-[#12111d]/75 glass-panel rounded-2xl p-8 shadow-2xl border-purple-950/40">
        <div className="text-center mb-8">
          <span className="font-accent text-sm font-bold tracking-widest text-purple-300">
          ...
          <p className="text-xs text-gray-500 mt-1 uppercase tracking-widest">
            Access your secure certificates
          </p>
        </div>
